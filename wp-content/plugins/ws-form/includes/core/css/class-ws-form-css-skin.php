...
.wsf-label-position-inside .iti input.wsf-field[placeholder] + .wsf-input-group-append + label {
	left: <?php self::e((($this->grid_gutter / 2) + $this->spacing_horizontal + $this->border_width + 30) . $uom); ?>;
}
...
<?php
	...
	switch($this->label_position_inside_mode) {
		...
		case 'move' :
?>
	transform: translate(<?php self::e('-40' . $uom); ?>, <?php self::e($this->label_column_inside_offset . $uom); ?>) scale(<?php self::e($this->label_column_inside_scale); ?>);
<?php
			break;
	}
?>
